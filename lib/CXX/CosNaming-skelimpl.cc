  ...
  CORBA_Environment *ev)
{
    ...
    CORBA::Object *obj_ = reinterpret_cast<CORBA::Object *>(object->impl_obj);
    CosNaming::NamingContext__impl *impl = dynamic_cast<CosNaming::NamingContext__impl *>(obj_);
    CosNaming::BindingIterator* bip = new CosNaming::BindingIterator((CORBA_Object)bi);
    impl->list(CORBA::ULong_CInArg(how_many ), CosNaming::BindingList_COutArg(bl ), CosNaming::BindingIterator_ptr(bip ));
#else /* C */
    /* ------   insert method code here   ------ */
    /* ------ ---------- end ------------ ------ */
#endif /*__cplusplus */
  ...
  CORBA_Environment *ev)
{
  ...
  memset(ev, 0, sizeof(CORBA_Environment));
    ...
    CosNaming::NamingContextExt::StringName var = impl->to_string(CosNaming::Name_CInArg(n ));
  /* type = 25 */
    retval = var;
    ev->_cpp_flag = 1;
#else /*  C  */
  ...
  CORBA_Environment *ev)
{
  ...
  memset(ev, 0, sizeof(CORBA_Environment));
    ...
    CORBA::Object *obj_ = reinterpret_cast<CORBA::Object*>(object->impl_obj);
    CosNaming::NamingContextExt__impl *impl = dynamic_cast<CosNaming::NamingContextExt__impl *>(obj_);
    CosNaming::NamingContextExt::URLString var = impl->to_url(CosNaming::NamingContextExt::Address_CInArg(addr ), CosNaming::NamingContextExt::StringName_CInArg(sn ));
  /* type = 25 */
    retval = var;
    ev->_cpp_flag = 1;
#else /*  C  */
